...
.card {
  @apply cursor-pointer overflow-hidden rounded-md
   bg-orange-100 p-8 shadow-md transition-transform 
   duration-300 hover:scale-110 hover:shadow-2xl 
  ...
  &-details {
    ...
    &-job {
      @apply -mt-2 text-xs font-bold text-gray-700;
    }
    &-quote {
      @apply pt-4 text-lg italic text-gray-600;
    }
  }
}
</style>
